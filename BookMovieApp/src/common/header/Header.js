...
export default function Header({ baseUrl }) {
   ...
   const [isRevealPwd]=useState(false);//To hide the characters of password
    ...
    */
    const loginButtonHandler = () => {
        ...
        password === "" ? setReqPassword("dispNone") : setReqPassword("dispNone");
        if (
            userName === "" ||
            password === ""
        ) {
    ...
    */
    const registerButtonHandler = () => {
        ...
        registration.password === "" ? setReqRegPassword("dispNone") : setReqRegPassword("dispNone");
