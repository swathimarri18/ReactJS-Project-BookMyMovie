                ...
                <ImageList rowHeight={250} cols={6} >
                    {upcomingMovies.map(upcomingMovie => (
                        <ImageListItem key={upcomingMovie.id}>
                            <img alt="Poster not found in database" src={upcomingMovie.poster_url} height='250' />
                            <ImageListItemBar
                    ...
                    <ImageList rowHeight={350} cols={4} gap={16} >
                        {releasedMovies.map(releasedMovie => (
                            ...
                            <ImageListItem key={releasedMovie.id}>
                                ...
                                <Link to={`/movie/${releasedMovie.id}`}><img alt="Poster not found in database" src={releasedMovie.poster_url} /></Link>

                                <ImageListItemBar
                                    title={releasedMovie.title}
                                    subtitle={<span>Release Date:{new Date(releasedMovie.release_date).toDateString()}</span>}
                                    />
